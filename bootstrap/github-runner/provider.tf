...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.stud.idi.ntnu.no/api/v4/projects/31103/terraform/state/runner"
    lock_address   = "https://gitlab.stud.idi.ntnu.no/api/v4/projects/31103/terraform/state/runner/lock"
    unlock_address = "https://gitlab.stud.idi.ntnu.no/api/v4/projects/31103/terraform/state/runner/lock"
    lock_method    = "POST"

...
terraform {
  ...
  backend "http" {
    address        = "https://gitlab.stud.idi.ntnu.no/api/v4/projects/31103/terraform/state/dev-compute"
    lock_address   = "https://gitlab.stud.idi.ntnu.no/api/v4/projects/31103/terraform/state/dev-compute/lock"
    unlock_address = "https://gitlab.stud.idi.ntnu.no/api/v4/projects/31103/terraform/state/dev-compute/lock"
    lock_method    = "POST"
...
data "terraform_remote_state" "network" {
  backend = "http"
  config = {
    address  = "https://gitlab.stud.idi.ntnu.no/api/v4/projects/31103/terraform/state/dev-network"
  }
}